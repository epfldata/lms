...
trait K3PersistentCollectionExp extends K3PersistentCollectionOps with GeneratorOpsExp with BaseExp with EffectExp with VariablesExp {
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer)(implicit pos: SourceContext): Exp[A] = (e match {
    ...
    case Reflect(e@NewK3PersistentCollection(mK, mV, name, elems, sndIdx), u, es) => reflectMirrored(Reflect(NewK3PersistentCollection(mtype(mK), mtype(mV), f(name), f(elems), f(sndIdx)), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)
    case Reflect(K3Contains(x, key), u, es) => reflectMirrored(Reflect(K3Contains(f(x), f(key)), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)
    case Reflect(e@K3Lookup(x, key), u, es) => reflectMirrored(Reflect(K3Lookup(f(x), f(key))(mtype(e.mV)), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)
    case Reflect(e@K3LookupOrDefault(x, key, defaultVal), u, es) => reflectMirrored(Reflect(K3LookupOrDefault(f(x).asInstanceOf[Exp[K3PersistentCollection[Any, A]]], f(key), f(defaultVal))(mtype(e.mV)), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)
    case Reflect(K3UpdateValue(x, key, value), u, es) => reflectMirrored(Reflect(K3UpdateValue(f(x), f(key), f(value)), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)
    case Reflect(K3Remove(x, key), u, es) => reflectMirrored(Reflect(K3Remove(f(x), f(key)), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)  
    case Reflect(K3Clear(x), u, es) => reflectMirrored(Reflect(K3Clear(f(x)), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)  
    case Reflect(K3Mutable(x), u, es) => reflectMirrored(Reflect(K3Mutable(f(x)), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)  
    case Reflect(e@K3Slice(x, kp, idx), u, es) => reflectMirrored(Reflect(K3Slice(f(x), f(kp), f(idx))(mtype(e.mK),mtype(e.mV),mtype(e.mK2)), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)  
    case Reflect(K3Foreach(a, x, body), u, es) => reflectMirrored(Reflect(K3Foreach(f(a), x, f(body)), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)  
